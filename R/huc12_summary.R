...
spec_huc12 <- function() {
  spec <- tspec_object(
    tib_df(
      ...
      tib_dbl("assessedGoodCatchmentAreaSqMi"),
      tib_dbl("assessedGoodCatchmentAreaPercent"),
      tib_dbl("assessedUnknownCatchmentAreaSqMi"),
      tib_dbl("assessedUnknownCatchmentAreaPercent"),
